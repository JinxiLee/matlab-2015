...
X_mosaic_number=12;%12;
Y_mosaic_number=16;%16;


starting_frame_index=10;   %0.2 micron per frame, start from 1
...
for NNN=1:total_stack_number
    ...
    for N=0:(total_FOV_number-1)
        ...
        if (X_number<10)&&(Y_number<10)
            folder_path=sprintf('D:\\OCT data\\150727\\2015_0727_150727_pig skin_3rd(50 micron)_% d_% d\\',X_number,Y_number);
