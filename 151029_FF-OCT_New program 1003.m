...
folder_path_without_index='D:\OCT data\151029\151029_Temp blood\';
...
elseif correction_set == 3
    ...
    cmin=9;%12;%11
    cmax_set=15;%16;%60;%120;%20;
    start_index_offset_from_max=0;
    G_Ratio=1.5;
    Gaussian_X_width=200*G_Ratio;
    Gaussian_Y_width=200*G_Ratio;
    X_offset=50;
    Y_offset=50;
end
...
X_mosaic_starting_index=9;%6;%1;  %start from 0
Y_mosaic_starting_index=12;%8;%1;
...
for NNN=1:total_stack_number
    ...
    for N=0:(total_FOV_number-1)
        ...
        cd(folder_path);
        residual_frame=frame_average_factor;
