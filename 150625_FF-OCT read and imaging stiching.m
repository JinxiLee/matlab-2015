...
for N=0:(total_FOV_number-1)
    ...
    folder_path=sprintf('D:\\OCT data\\150626\\2015_0626_%d\\',N+1);
    cd(folder_path);
    mkdir('divide');
...
%imwrite(averaged_image/normalization_factor,[cd,'\divide\',sprintf('averaged_frame_%d',N),'.png']);
