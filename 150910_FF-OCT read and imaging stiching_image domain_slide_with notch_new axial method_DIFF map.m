...
folder_path_without_index='D:\OCT data\150907\2015_0907_150907_1st';
...
X_mosaic_starting_index=3;%1;  %start from 0
Y_mosaic_starting_index=4;%1;


X_mosaic_number=3;%6;%3;%12;%12;
Y_mosaic_number=4;%8;%4;%16;%16;
...
for NNN=1:total_stack_number
    ...
    for N=0:(total_FOV_number-1)
        ...
        if strcmp(map_method,'mean')==1
            ...
            if (X_number==4) && (Y_number==5)
                Averaged_frame=(Averaged_frame-cmin*1.1)/(cmax_set*1.2);  %因為無從做max intensity判斷, 只好用固定值
            else
