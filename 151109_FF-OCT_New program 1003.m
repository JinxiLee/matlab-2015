...
folder_path_without_index='D:\OCT data\151109_Teeth_Temp\';
...
elseif correction_set == 3
    ...
    cmin=12;%12;%11
    cmax_set=18;%16;%60;%120;%20;
    start_index_offset_from_max=20;
    G_Ratio=1.5;
...
X_mosaic_starting_index=12;%+6;%6;%1;  %start from 0
Y_mosaic_starting_index=16;%+8;%8;%1;


X_mosaic_number=12;%-9;%6;%3;%12;%12;
Y_mosaic_number=16;%-12;%8;%4;%16;%16;
