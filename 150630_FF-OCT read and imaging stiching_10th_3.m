...
Gaussian_X_width=550;
Gaussian_Y_width=375;
X_offset=300;
Y_offset=0;
...
for N=0:(total_FOV_number-1)
    ...
    folder_path=sprintf('D:\\OCT data\\150701\\separate\\10th_3\\2015_0701_10th_%d\\',N+1);
    cd(folder_path);
    mkdir('divide');
...
Normailzed_image=(stiched_image-cmin)/(cmax-5);
