...
division_starting_index=1;
total_division_number=4;

frame_starting_index=36;
total_frame_number=25;
...
for N=0:(total_FOV_number-1)
    ...
    folder_path=sprintf('D:\\OCT data\\150630\\2015_0630_0412_large FOV_critical illumination_%d\\',N+1);
    cd(folder_path);
    mkdir('divide');
...
imwrite(Normailzed_image,[cd,'\divide\','averaged_frame.png','.png']);
