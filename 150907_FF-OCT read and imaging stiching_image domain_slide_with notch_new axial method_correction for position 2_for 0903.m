...
folder_path_without_index='D:\OCT data\150903\2015_0903_150903_3rd';
...
if correction_set == 1
    cmin=12;%12;%11
    cmax_set=8;%16;%60;%120;%20;       %其實這不是max, 而是span, 故可以小於cmin
...
X_mosaic_starting_index=4;%4;%4;%+3-1;  %start from 0
Y_mosaic_starting_index=1;%1;%2;%1;%+3-2;


X_mosaic_number=6;%6;%3;%6;%-3;%12;%12;
Y_mosaic_number=8;%8;%4;%8;%-3;%16;%16;
