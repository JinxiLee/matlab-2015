...
for NNN=1:total_stack_number
    ...
    for N=0:(total_FOV_number-1)
        ...
        if (X_number<10)&&(Y_number<10)
            folder_path=sprintf('D:\\OCT data\\150803\\2015_0804_150803_nevi_21th(200 micron)_% d_% d\\',Y_number,X_number);
    ...
    imwrite(stiched_image,[cd,'\divide\',sprintf('stiched_image_%.1f micron',(starting_frame_index+(NNN-1)*frame_average_factor)*0.2),'.png']);
