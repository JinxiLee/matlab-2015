...
folder_path_without_index='D:\OCT data\151229_MMH\151229_Temp_26th scan\';
...
elseif correction_set == 3
    ...
    cmin=8.3;%12;%11
    cmax_set=8.5;%16;%60;%120;%20;
    G_Ratio=1.5;
    Gaussian_X_width=350*G_Ratio;
    Gaussian_Y_width=380*G_Ratio;
    X_offset=15;
    Y_offset=-55;
...
X_mosaic_starting_index=6;%13;%+6;%6;%1;  %start from 0
Y_mosaic_starting_index=8;%17;%+8;%8;%1;


X_mosaic_number=12;%3;%-9;%6;%3;%12;%12;
Y_mosaic_number=16;%4;%-12;%8;%4;%16;%16;
