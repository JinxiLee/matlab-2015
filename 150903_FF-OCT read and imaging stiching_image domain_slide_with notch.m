...
folder_path_without_index='D:\OCT data\150903\2015_0903_150903_1st';
...
starting_frame_index=50;   %0.2 micron per frame, start from 1
frame_average_factor=20;    %averaged to stack
total_stack_number=5;
...
if if_notch==1
    ...
    notch_image=ones(frame_width,frame_height)-(notch_X_mat.*notch_Y_mat);
    correction_image=correction_image./notch_image;
end
...
for NNN=1:total_stack_number
    ...
    the_starting_frame_index_in_the_first_division=starting_frame_index+(NNN-1)*frame_average_factor-division_starting_index*num_of_frame_per_division+1; %corrected, add 1
