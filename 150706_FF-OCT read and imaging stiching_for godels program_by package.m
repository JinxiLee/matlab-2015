...
division_starting_index=5;
total_division_number=41;
...
for NN=1:length(division_number)
    for N=0:(total_FOV_number-1)
        ...
        folder_path=sprintf('D:\\OCT data\\150706\\2015_0706_teeth_1st_ %d_ %d\\',X_number,Y_number);
        cd(folder_path);
        mkdir('divide3');
    ...
    for QQQ=1:4
        ...
        imwrite(Normailzed_image,[cd,'\divide2\',sprintf('stiched_image_%d.png',(NN-1)*4+QQQ),'.png']);
    end
    %for QQQ=1:16
